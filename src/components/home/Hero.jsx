            ...
            <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
                <div className="space-y-8">
                    ...
                    >
                        ...
                        <h2 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] uppercase">
                            Elevate Your <br />
                            <span className="text-accent underline decoration-accent/30 decoration-8 underline-offset-8">Style</span>
                        </h2>
                        <p className="max-w-md text-foreground/60 text-lg leading-relaxed mt-6">
                            Experience the perfect blend of luxury and comfort. Handpicked premium selections curated just for you.
                        </p>
                    </motion.div>
                    ...
                    >
                        <Link to="/products">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="bg-foreground text-background px-8 py-4 rounded-full font-black flex items-center gap-3 transition-colors hover:bg-accent group shadow-xl"
                            >
                                SHOP COLLECTION
                        ...
                        <button className="flex items-center gap-3 font-bold hover:text-accent transition-colors">
                            <div className="w-12 h-12 rounded-full border border-foreground/10 flex items-center justify-center group hover:border-accent shadow-sm">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-xs text-foreground/40 font-bold uppercase tracking-widest">Happy Customers</p>
                        </div>
                        <div>
                            <p className="text-3xl font-black">200+</p>
                            <p className="text-xs text-foreground/40 font-bold uppercase tracking-widest">Premium Brands</p>
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="relative">
                    ...
                    <motion.div
                        ...
                        className="absolute top-[10%] right-[10%] w-32 h-32 glass rounded-full flex items-center justify-center p-4 text-center text-[10px] font-bold uppercase tracking-widest text-accent z-20 shadow-xl"
                    >
                        Top Rated
                    </motion.div>
                </div>
