                                ...
                                {step === 2 && (
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {[
                                                { id: 'upi', icon: Smartphone, title: 'UPI', desc: 'GPay, PhonePe, Paytm' },
                                                { id: 'card', icon: CreditCard, title: 'Card', desc: 'Visa, Mastercard, RuPay' },
                                                { id: 'netbanking', icon: Globe, title: 'Net Banking', desc: 'All Indian Banks' },
                                                { id: 'wallet', icon: Wallet, title: 'Wallet', desc: 'Amazon Pay, Mobikwik' }
                                            ].map(method => (
                                                <div
                                                    key={method.id}
                                        ...
                                        <div className="pt-6 border-t border-foreground/10">
                                            {selectedPayment === 'upi' && (
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                                                    <Input label="Enter UPI ID" placeholder="example@okhdfcbank" />
                                                    <p className="text-[10px] text-foreground/40 font-bold uppercase">You will receive a payment request on your UPI app.</p>
                                                </motion.div>
                                            )}
                                            ...
                                            {selectedPayment === 'netbanking' && (
                                                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
                                                    <div className="space-y-2">
                                                        ...
                                                        <select className="w-full bg-secondary/30 border border-foreground/5 px-5 py-4 rounded-xl focus:outline-none focus:border-accent transition-colors font-bold text-sm appearance-none cursor-pointer">
