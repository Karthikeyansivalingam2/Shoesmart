                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <motion.img
                                ...
                                alt={product.name}
                            />
                            <button className="absolute top-8 right-8 w-12 h-12 glass rounded-full flex items-center justify-center hover:bg-red-500 hover:text-white transition-colors">
                                <Heart size={20} />
                            </button>
                        </motion.div>
